...
namespace Hounds
{
    public class Encryption
    {
        ...
        private static readonly byte[] initVectorBytes = Encoding.ASCII.GetBytes("Ky1lH45AHug3==D~");//Protea IT "Penises are for security"
        //passphrase needs to be 12 characters long as a string.
        private static string passPhrase = "AmYkn0w5This";
